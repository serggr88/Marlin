...
#if MOTHERBOARD == 999
  #define _E0_PINS E0_BEGIN_PIN, E0_BEGIN_PIN + 1, E0_BEGIN_PIN + 2, E0_BEGIN_PIN + 3, E0_ENABLE_PIN, HEATER_0_PIN,
#else
...
#if MOTHERBOARD == 999
  #define SENSITIVE_PINS {0, 1, X_BEGIN_PIN, X_BEGIN_PIN + 1, X_BEGIN_PIN + 2, X_BEGIN_PIN + 3, X_ENABLE_PIN, X_MIN_PIN, X_MAX_PIN, Y_BEGIN_PIN, Y_BEGIN_PIN + 1, Y_BEGIN_PIN + 2, Y_BEGIN_PIN + 3, Y_ENABLE_PIN, Y_MIN_PIN, Y_MAX_PIN, Z_BEGIN_PIN, Z_BEGIN_PIN + 1, Z_BEGIN_PIN + 2, Z_BEGIN_PIN + 3, Z_ENABLE_PIN, Z_MIN_PIN, Z_MAX_PIN, PS_ON_PIN, \
